...
class BranchInfo:
    def __init__(self):
        ...
        # minimum values
        self.branch_min = {}
        self.branch_min['acop'] = TMath.Pi()/50
        self.branch_min['acthm'] = 0.01
        self.branch_min['btag1'] = 0.1
        self.branch_min['btag2'] = 0.1
        self.branch_min['ele_ene'] = 3
        ...
        self.branch_min['maxcthj'] = 0.1
        self.branch_min['maxxov'] = 0.05
        self.branch_min['mmis'] = 45
        self.branch_min['muon_ene'] = 1
        ...
        self.branch_min['thj1'] = 0.2
        self.branch_min['thj2'] = 0.2
        ...
        self.branch_max['maxxov'] = 0.85
        self.branch_max['mmis'] = 135
        self.branch_max['muon_ene'] = 17
        ...
        # number of bins
        self.branch_numbins = {}
        self.branch_numbins['acop'] = 20
        self.branch_numbins['acthm'] = 50
        self.branch_numbins['btag1'] = 19
        self.branch_numbins['btag2'] = 19
        self.branch_numbins['ele_ene'] = 12
        self.branch_numbins['ele_num'] = 4
        self.branch_numbins['ele_phi'] = 20
        self.branch_numbins['ele_the'] = 20
        ...
        self.branch_numbins['maxxov'] = 20
        self.branch_numbins['mmis'] = 18
        self.branch_numbins['muon_ene'] = 8
        self.branch_numbins['muon_num'] = 3
        self.branch_numbins['muon_phi'] = 20
        self.branch_numbins['muon_the'] = 20
        ...
        self.branch_numbins['pho_phi'] = 20
        self.branch_numbins['pho_the'] = 20
        self.branch_numbins['thj1'] = 20
        self.branch_numbins['thj2'] = 20
        self.branch_numbins['ucsdbt0'] = 20
        self.branch_numbins['xmj1'] = 14
        self.branch_numbins['xmj2'] = 14
